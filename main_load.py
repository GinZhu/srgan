...
def train():
    ...
    ###========================= load initial G =========================###
    init_g_npz_file = '/local/scratch/jz426/superResolution/results1/checkpoint/g_srgan_init.npz'
    tl.files.load_and_assign_npz(sess, name=init_g_npz_file, network=net_g)
    ###========================= train GAN (SRGAN) =========================###
